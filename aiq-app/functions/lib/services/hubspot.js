...
exports.syncToHubSpot = syncToHubSpot;
...
function getHubSpotClient() {
    ...
    return new api_client_1.Client({ accessToken });
}
// Create or update HubSpot contact
async function upsertContact(client, submission) {
...
async function storeAssessmentResults(client, contactId, submission, results) {
    const properties = {
...
async function triggerWorkflow(client, contactId, submission, results) {
...
// Main sync function
async function syncToHubSpot(submission, results) {
    try {
