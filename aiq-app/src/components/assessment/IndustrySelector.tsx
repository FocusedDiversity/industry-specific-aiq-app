...
const INDUSTRY_DESCRIPTIONS: Record<Industry, string> = {
  healthcare:
    "Hospitals, health systems, digital health, payers, and healthcare technology organizations",
  legal:
    "Law firms, corporate legal departments, legal technology providers, and professional services",
};
    ...
    <div className="space-y-4">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600">
          Choose the industry that best describes your organization for tailored
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3
                  className={`text-xl font-semibold ${isSelected ? "text-[#994745]" : "text-gray-900"}`}
                >
                  {displayName}
                </h3>
              </div>
              ...
              {/* Description */}
              <p
                className={`text-sm ${isSelected ? "text-[#cc5e58]" : "text-gray-600"}`}
              >
